...
fn build_character_defs() -> Vec<CharacterDef> {
    ...
    vec![
        CharacterDef {
            ...
            cost: 90,
            might: 10, reflexes: 10, wisdom: 10, hp: 50,
            properties: vec![],
        },
        CharacterDef {
            id: "picardia".into(),
        ...
        CharacterDef {
            ...
            cost: 100,
            might: 12, reflexes: 10, wisdom: 5, hp: 25,
        ...
        CharacterDef {
            ...
            cost: 120,
            might: 15, reflexes: 9, wisdom:30, hp: 75,
            properties: vec![BuffFormationFront { might: 5, reflexes: 5, wisdom: 5, hp: 5 }],
        },
        CharacterDef {
            id: "isoceles".into(),
            name: "Isoceles".into(),
        ...
        CharacterDef {
            ...
            cost: 90,
            might: 6, reflexes: 10, wisdom: 10, hp: 100,
            properties: vec![],
        },
        CharacterDef {
            id: "gren".into(),
...
fn build_item_defs() -> Vec<ItemDef> {
    vec![
        ...
        ItemDef {
            ...
            cost: 30,
            slot: GearSlot::Hat,
            properties: vec![Property::StatBonus { might: 0, reflexes: 0, wisdom: 0, hp: 25 }],
        },
        ItemDef {
            id: "fedora_hat".into(),
            name: "Fedora".into(),
        ...
        ItemDef {
            ...
            cost: 80,
            slot: GearSlot::Hat,
            properties: vec![Property::StatBonus { might: 0, reflexes: 5, wisdom: 0, hp: 0 }],
        },
        ItemDef {
            id: "viking_hat".into(),
        ...
        ItemDef {
            ...
            cost: 70,
            slot: GearSlot::Hand,
            properties: vec![Property::StatBonus { might: 0, reflexes: 0, wisdom: 5, hp: 0 }],
        },
        ItemDef {
            id: "spear".into(),
            name: "Spear".into(),
            ...
            slot: GearSlot::Hand,
            properties: vec![
                Property::StatBonus { might: 5, reflexes: 0, wisdom: 0, hp: 0 },
        ...
        ItemDef {
            ...
            cost: 200,
            slot: GearSlot::Hand,
            properties: vec![Property::MeleeCleave { count: MAX_TEAM as u8 }],
        },
    ]
}
